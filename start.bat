...
docker run -it --rm -p 7860:7860 --gpus all --name anitts-container-%INPUT_NAME% -v "%~dp0data_%INPUT_NAME%:/workspace/AniTTS-Builder-v3/data" -v "%~dp0module/model:/workspace/AniTTS-Builder-v3/module/model" anitts-builder-v3
